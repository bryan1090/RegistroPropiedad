 ...
 */
@Dependent
public class EnviarModelosSRI implements Serializable {
    ...
    public void cargarModelos() throws ServicioExcepcion, Exception {
      ...
      //  mail = hostMailServicio.obtenerPorConsultaJpaNombrada(mail.LISTAR_TODO, null);
        ...
        for (Factura factura : listaFactura) {
            ...
            asignarModeloSri(factura, institucion, facturaDetalle, pathDocEle);
        }
    }
    
    public void asignarModeloSri(Factura factura, Institucion institucion, List<FacturaDetalle> listaDetalle, PathDocEle pathDocEle) throws ServicioExcepcion, Exception {
        //BCLIENTEB
        ...
        while (it.hasNext()) {
            ...
            next.setFdtTtrDescripcion(verificarTildes(next.getFdtTtrDescripcion()));
            ...
            add1.setCodigo("COD1");
            add1.setDescripcion(next.getFdtTtrDescripcion());
