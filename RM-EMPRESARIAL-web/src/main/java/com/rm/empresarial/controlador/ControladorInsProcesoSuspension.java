 ...
 * @author MP
 */
@Named(value = "controladorInsProcesoSuspension")
@ViewScoped
public class ControladorInsProcesoSuspension implements Serializable {
    ...
    public ControladorInsProcesoSuspension() {
...
//                }
        ...
        try {
            ...
            controladorInscripcionProceso.llenarDatos();
