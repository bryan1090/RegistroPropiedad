 ...
 * @author Bryan_Mora
 */
@Named(value = "controladorInscripcionJudicialSuspension")
@ViewScoped
public class ControladorInscripcionJudicialSuspension implements Serializable {
    ...
    public ControladorInscripcionJudicialSuspension() {
...
//        }
    ...
    public void salir() throws IOException {
        FacesContext.getCurrentInstance().getExternalContext().redirect("/RM-EMPRESARIAL-web/paginas/PROCESOS/Demanda/Demanda.xhtml");
...
//                }
        ...
        try {
            ...
            controladorInscripcionJudicial.llenarDatos();
