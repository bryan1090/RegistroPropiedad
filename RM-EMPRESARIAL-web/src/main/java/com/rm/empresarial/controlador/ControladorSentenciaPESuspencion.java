 ...
 * @author Bryan_Mora
 */
@Named(value = "controladorSentenciaPESuspension")
@ViewScoped
public class ControladorSentenciaPESuspencion implements Serializable {
    ...
    public ControladorSentenciaPESuspencion() {
...
//        
        ...
        try {
            ...
            controladorSentenciaPE.llenarDatos();
