 ...
 * @author Bryan_Mora
 */
@Named(value = "controladorDemandaSuspension")
@ViewScoped
public class ControladorDemandaSuspencion implements Serializable {
    ...
    public ControladorDemandaSuspencion() {
...
//        }
    ...
    public void salir() throws IOException {
        FacesContext.getCurrentInstance().getExternalContext().redirect("/RM-EMPRESARIAL-web/paginas/PROCESOS/InscripcionJudicial/InscripcionJudicial.xhtml");
