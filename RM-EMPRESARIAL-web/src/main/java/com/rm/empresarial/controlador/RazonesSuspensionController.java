 ...
 * @author Bryan_Mora
 */
@Named(value = "razonesSuspensionController")
@ViewScoped
public class RazonesSuspensionController implements Serializable {
	...
	@Getter
	@Setter
	private Boolean disabledComponent = true;
	@Getter
	@Setter
	...
	public RazonesSuspensionController() {
...
//                if (servicioTramiteSuspension.buscarTramitesSuspensionPorNumTramYporEstadoS(numProforma).size() > 0) {
				listaTramiteSuspension = servicioTramiteSuspension.buscarTramitesSuspensionPorNumTram(numProforma);
				listaTramiteSuspensionesAntes = servicioTramiteSuspension.buscarTramitesSuspensionPorNumTram(numProforma);
...
//                        "Se encontraron " + servicioTramiteSuspension.buscarTramitesSuspensionPorNumTram(getNumProforma()).size()
//                        + " trámites suspensión", ""));
//                }
//                else
//                {
...
//                }
				...
				mostrarGrid2 = false;
//                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
//                        "Numero de Trámite encontrado ", ""));

			}

		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("Error, Posiblemente Tramite no existe");
...
//        }
	...
	public void insertarTramitesSuspensionCaso2() throws DocumentException, BadElementException, IOException {
//        String nombreUsuario = dataManagerSesion.getUsuarioLogeado().getUsuLogin();
		Boolean exito = false;
		if (tramiteSeleccionado != null) {
...
//            }
			...
			if (listaTramiteSuspension != null) {
				...
				pdf.add(new Paragraph("\n"));
				Font fuente1 = new Font(Font.FontFamily.HELVETICA, 10, Font.UNDERLINE);
