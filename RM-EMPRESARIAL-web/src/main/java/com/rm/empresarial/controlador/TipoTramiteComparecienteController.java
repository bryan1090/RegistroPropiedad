...
@Named("tipoTramiteComparecienteController")
@SessionScoped
public class TipoTramiteComparecienteController implements Serializable {

    @EJB
    private TipoTramiteComparecienteServicio ejbFacade;
    private List<TipoTramiteCompareciente> items = null;
    private TipoTramiteCompareciente selected;

    public TipoTramiteComparecienteController() {
    }
...
//    }
//
//    public List<TipoTramiteCompareciente> getItemsAvailableSelectOne() {
//        return getFacade().findAll();
//    }

    @FacesConverter(forClass = TipoTramiteCompareciente.class)
    public static class TipoTramiteComparecienteControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TipoTramiteComparecienteController controller = (TipoTramiteComparecienteController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "tipoTramiteComparecienteController");
